...
//start class 
public class JavaBowlingScoringSystem
{
    public static void main(String args[])
    {
        ...
        do
        {
            ...
            else if(scoringboard[0][9] + scoringboard[1][9] == 10)//if frame 10 got spare
            {
            ...
            if(scoringboard[0][0] == 10)//for strike
            {
            ...
            {
                if(scoringboard[0][9] != 0)//spare with a hit in the first shot
                {
                ...
                else//spare with a miss in the first shot
                {
                    if(scoringboard[0][10] == 10)//a spare and a strike
                        System.out.print(" - | / | X |");
                    else if(scoringboard[0][10] != 0)//a spare and a shot
                        System.out.print(" - | / | " +scoringboard[0][10]+ " |");
                    else//a spare and a miss
                        System.out.print(" - | / | - |");
                }
            }
